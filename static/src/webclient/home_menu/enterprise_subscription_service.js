...
// Subscription UI has been removed; no expired subscription overlay is registered.

export const enterpriseSubscriptionService = {
    name: "enterprise_subscription",
    dependencies: ["orm", "notification"],
    start(env, { orm, notification }) {
        // Neutralized: do not register any subscription UI and return a no-op service.
        return reactive({
