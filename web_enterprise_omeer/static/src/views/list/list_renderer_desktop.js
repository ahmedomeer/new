...
import { PromoteStudioDialog } from "@web_enterprise_omeer/webclient/promote_studio/promote_studio_dialog";
    ...
    setup() {
        ...
        if (isPotentiallyEditable) {
            const computeStudioEditable = (action) => {
                ...
                if (action.res_model === "knowledge_omeer.article") {
                    // The knowledge_omeer form view is very specific and custom, it doesn't make sense
